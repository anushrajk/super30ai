...
const config: ServicePageConfig = {
  seo: {
    ...
    description: "Boost brand visibility with our social media marketing agency in Bangalore. From strategy to content, we drive engagement & ROI across all platforms. Talk to Us!",
    keywords: "social media marketing agency in bangalore, social media marketing services in bangalore, social media management bangalore, instagram marketing bangalore, facebook marketing bangalore",
    canonical: "https://www.thesuper30.ai/social-media-marketing-agency-bangalore",
    serviceType: "Social Media Marketing",
    ogTitle: "Turn Followers Into Customers. Not Just Numbers.",
    ogDescription: "Strategy, content & paid ads that drive real engagement and ROI across every social platform.",
    twitterTitle: "Turn Followers Into Customers. Not Just Numbers.",
    twitterDescription: "Strategy, content & paid ads that drive real engagement and ROI across every social platform.",
  },
  hero: {
    badgeIcon: Megaphone,
    ...
    description: <>End-to-end social media marketing services across Instagram, Facebook, LinkedIn & YouTube — built to <span className="text-foreground font-semibold">drive engagement, leads and revenue</span>, not just vanity metrics.</>,
    trustSignals: [
