...
const config: ServicePageConfig = {
  seo: {
    ...
    description: "Attract more visitors with blogs that rank. Our blog writing agency in Bangalore crafts SEO articles that build authority and grow traffic. Let's Write!",
