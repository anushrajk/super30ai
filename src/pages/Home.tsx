...
import { ArrowRight, Bot, Target, TrendingUp, Users, Award, Zap, BarChart3, Search, MousePointerClick, CheckCircle2, Sparkles, Globe, Building2, ShoppingCart, Briefcase, GraduationCap, Stethoscope, Rocket, Home as HomeIcon, Scale, Utensils } from "lucide-react";
        ...
        <div className="container relative mx-auto px-4 py-12 lg:py-20">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center lg:text-left">
              ...
              {/* Platform Logos */}
              <div className="flex items-center gap-4 justify-center lg:justify-start mb-8 flex-wrap">
                <span className="text-xs text-muted-foreground uppercase tracking-wider">30+ Experienced Marketers:</span>
                <div className="flex items-center gap-3">
                  {/* Google */}
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm border border-border/50" title="Google">
                  ...
                  {/* Meta */}
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm border border-border/50" title="Meta">
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
                  ...
                  {/* WhatsApp */}
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm border border-border/50" title="WhatsApp">
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
                  ...
                  {/* LinkedIn */}
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center shadow-sm border border-border/50" title="LinkedIn">
                    <svg viewBox="0 0 24 24" className="w-5 h-5">
                      <path fill="#0A66C2" d="M20.447 20.452h-3.554v-5.569c0-1.328-.027-3.037-1.852-3.037-1.853 0-2.136 1.445-2.136 2.939v5.667H9.351V9h3.414v1.561h.046c.477-.9 1.637-1.85 3.37-1.85 3.601 0 4.267 2.37 4.267 5.455v6.286zM5.337 7.433a2.062 2.062 0 01-2.063-2.065 2.064 2.064 0 112.063 2.065zm1.782 13.019H3.555V9h3.564v11.452zM22.225 0H1.771C.792 0 0 .774 0 1.729v20.542C0 23.227.792 24 1.771 24h20.451C23.2 24 24 23.227 24 22.271V1.729C24 .774 23.2 0 22.222 0h.003z"/>
                    </svg>
                  </div>
                  {/* 100+ Tools */}
                  <div className="h-8 px-3 bg-gradient-to-r from-orange-500 to-orange-600 rounded-lg flex items-center justify-center shadow-sm" title="100+ Tools">
                    <span className="text-xs font-bold text-white">100+ Tools</span>
                  </div>
                </div>
              </div>
