  ...
  return (
    <>
      ...
      <main className="min-h-screen pt-16 md:pt-20">
        {/* Hero Section */}
        <section id="about-hero" className="relative bg-background overflow-hidden py-16 lg:py-24">
          {/* Animated background */}
          ...
          <div className="absolute top-1/2 left-1/4 w-24 h-24 bg-brand/15 rounded-full blur-2xl" />
