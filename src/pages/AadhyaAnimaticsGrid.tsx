...
const AadhyaAnimaticsGrid = () => {
  const [active, setActive] = useState<number | null>(null);

  return (
    <>
      <Helmet>
        <title>Aadhya Animatics Instagram Grid | Social Creative Portfolio</title>
        <meta
          name="description"
          content="A curated Instagram grid for Aadhya Animatics showcasing 2D, 3D and CGI animation creatives, campaign posts and festive designs by The Super 30."
        />
        <meta name="robots" content="noindex, follow" />
        <meta property="og:title" content="Aadhya Animatics Instagram Grid" />
        <meta property="og:description" content="Curated Instagram feed design for Aadhya Animatics — animation, CGI and campaign creatives." />
...
export default AadhyaAnimaticsGrid;
