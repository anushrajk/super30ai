      ...
      <Helmet>
        ...
        <script type="application/ld+json">
          {JSON.stringify({
            ...
            "description": "The Super 30 is a leading digital marketing agency in Bangalore offering AI-powered SEO, PPC, social media marketing, web design, and content marketing services for businesses of all sizes.",
            "image": "https://www.thesuper30.ai/og-image.png",
            ...
            "mainEntity": [
              {
                ...
                "acceptedAnswer": { "@type": "Answer", "text": "The Super 30 combines 30+ in-house marketing experts with AI-powered tools to deliver measurable results across SEO, PPC, social media, and web design. We focus on revenue attribution, not vanity metrics, making us a trusted digital marketing agency in Bangalore for 300+ brands." }
              },
              {
                "@type": "Question",
                "name": "How much does a digital marketing agency in Bangalore charge?",
                "acceptedAnswer": { "@type": "Answer", "text": "Digital marketing services in Bangalore typically range from ₹25,000 to ₹5,00,000 per month depending on scope, channels, and business goals. At The Super 30, we offer custom packages starting at ₹50,000/month with transparent pricing and no hidden costs." }
              },
              {
                "@type": "Question",
                "name": "Which industries does your digital marketing agency in Bangalore serve?",
                "acceptedAnswer": { "@type": "Answer", "text": "As a full-service digital marketing agency in Bangalore, we serve Real Estate, Education, Healthcare, E-commerce, SaaS, Professional Services, Hospitality, Legal, and Staffing industries with proven results across each vertical." }
              }
            ]
          })}
        </script>
      ...
      <main className="min-h-screen pt-16 md:pt-20">
        <div id="dm-hero">
          <ServiceHeroSection
            ...
            description={
              <>
                We're not just another digital marketing agency in Bangalore. With 30+ in-house experts and AI-powered strategies, we deliver{" "}
                <span className="text-foreground font-semibold">10x growth across SEO, PPC, social media & web design</span> — all under one roof. 300+ brands trust us.
              </>
            }
            trustSignals={[
              { icon: Bot, text: "AI-Powered Digital Marketing Strategies" },
