...
const services = [
  {
    ...
    features: ["AI-Powered Keyword Research", "Technical SEO Audits", "Content Strategy & Creation", "Link Building & Authority"],
  ...
  },
  {
    ...
    features: ["Google & Meta Ads Management", "AI Bid Optimization", "Conversion Rate Optimization", "Retargeting & Lookalike Audiences"],
  ...
  },
  {
    ...
    features: ["Content Calendar Planning", "Community Management", "Short-Form Video (Reels/Shorts)", "Influencer Collaborations"],
  ...
  },
  {
    ...
    features: ["Brand Identity & Guidelines", "Social Media Creatives", "Marketing Collaterals", "Presentation Design"],
    href: "/design",
    accent: "38 92% 50%",
  },
  {
    ...
    features: ["Landing Page Design", "Responsive Web Development", "Speed & Core Web Vitals", "UI/UX Optimization"],
  ...
  },
  {
    ...
    features: ["Automated Email Sequences", "Lead Nurturing Funnels", "Newsletter Strategy", "Content Writing & Blogs"],
    href: "/contact",
    accent: "0 84% 60%",
  },
];
