...
const ContentCard = ({ card }: { card: typeof cards[0] }) => {
  const [open, setOpen] = useState(false);

  return (
    <div className="border border-border/50 rounded-2xl bg-card overflow-hidden transition-colors">
      <button
  ...
  <section className="py-14 md:py-24 lg:py-32 bg-background">
    <div className="container mx-auto px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="text-xs text-muted-foreground/60 mt-8 pt-6 border-t border-border/50">
