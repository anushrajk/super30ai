...
const forYou = [
  "You're spending ₹1L+/mo across channels but can't connect spend to revenue",
  "You want one team managing SEO, ads, social, and design together",
  "You need a strategy that compounds, not just quick wins",
  "You're tired of agencies that report impressions but not pipeline",
  "You want AI-powered optimization across all channels",
  "You value transparency and data-driven decisions",
];

const notForYou = [
  "You just want to buy followers or fake engagement",
  "Your total monthly budget is under ₹25k",
  "You expect results without investing in strategy",
  "You're looking for a single freelancer, not a team",
  "You change agencies every 2 months",
];
      ...
      <div className="container mx-auto px-4 relative">
        <div className={`text-center max-w-3xl mx-auto mb-6 md:mb-10 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">
            Is Full-Service Digital Marketing Right For You?
          </h2>
