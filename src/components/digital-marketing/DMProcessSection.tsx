...
const steps = [
  { icon: Search, number: "01", title: "Deep Discovery & Audit", description: "Complete audit of your digital presence, competitors, and market position across all channels — tailored for Bangalore's competitive landscape." },
  { icon: Layers, number: "02", title: "Custom Strategy Blueprint", description: "A bespoke digital marketing roadmap with channel priorities, budget allocation, content calendar & KPI targets aligned to your revenue goals." },
  { icon: Rocket, number: "03", title: "Multi-Channel Execution", description: "Our 30+ Bangalore-based digital marketing experts launch SEO, ads, social, email & web campaigns simultaneously with AI-assisted optimization." },
  { icon: TrendingUp, number: "04", title: "Optimize, Report & Scale", description: "AI-driven A/B testing, cross-channel attribution, weekly strategy reviews & continuous scaling. Our digital marketing agency ensures compounding growth." },
];
...
export const DMProcessSection = () => {
  ...
  return (
    <section ref={sectionRef} className="py-10 md:py-16 lg:py-24 bg-muted/20 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className={`text-center max-w-3xl mx-auto mb-8 md:mb-14 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          <p className="text-lg text-muted-foreground">
            A structured, data-driven approach used by our digital marketing agency in Bangalore to take businesses from scattered marketing to predictable, scalable growth.
          </p>
        </div>
            ...
            >
              ...
              <Card className="bg-white border border-border/50 rounded-2xl">
                <CardContent className="p-4 md:p-6 text-center">
                  <div className="text-4xl md:text-5xl font-bold text-brand/20 mb-3">
                    {step.number}
                  </div>
