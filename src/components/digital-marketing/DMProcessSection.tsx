...
const steps = [
  { icon: Search, number: "01", title: "Deep Discovery", description: "Full audit of your digital presence, competitors, market position & growth opportunities across all channels" },
  { icon: Layers, number: "02", title: "Strategy Blueprint", description: "Custom roadmap with channel priorities, budget allocation, content calendar & KPI targets aligned to revenue goals" },
  { icon: Rocket, number: "03", title: "Multi-Channel Execution", description: "Our 30+ experts launch SEO, ads, social, email & web campaigns simultaneously with AI-assisted optimization" },
  { icon: TrendingUp, number: "04", title: "Optimize & Scale", description: "AI-driven A/B testing, cross-channel attribution, monthly strategy reviews & continuous scaling for maximum ROI" },
];
    ...
    <section ref={sectionRef} className="py-8 md:py-14 lg:py-20 bg-muted/30 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 relative">
        <div className={`text-center max-w-3xl mx-auto mb-6 md:mb-12 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          <BentoBadge className="mb-4">How It Works</BentoBadge>
          <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-foreground mb-4">
            Our Proven Growth Process
          </h2>
          <p className="text-lg text-muted-foreground">
            A structured, data-driven approach that takes your business from scattered marketing to predictable, scalable growth
          </p>
        </div>
