...
export const HeroServiceCard = ({
  ...
  return (
    <div className="bg-background/80 backdrop-blur-sm border border-border/50 rounded-2xl p-5 hover:border-primary/30 hover:shadow-xl transition-all duration-300 group w-full sm:min-w-[280px]">
