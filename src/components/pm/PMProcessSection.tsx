    ...
    <section ref={ref} className={`py-12 md:py-16 lg:py-24 bg-muted/30 transition-all duration-700 ${isVisible ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-10'}`}>
      <div className="container mx-auto px-4">
        <div className="text-center max-w-3xl mx-auto mb-10 md:mb-16">
          ...
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold text-foreground mb-4">How We Work</h2>
        </div>
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-6xl mx-auto">
          {steps.map((step, index) => (
            <div key={index} className="relative bg-background border border-border/50 rounded-2xl p-4 md:p-6 hover:shadow-xl transition-all duration-300">
              ...
              <div className="w-10 h-10 md:w-12 md:h-12 bg-gradient-to-br from-orange-100 to-orange-200 rounded-xl flex items-center justify-center mb-3 md:mb-4">
                <step.icon className="w-5 h-5 md:w-6 md:h-6 text-orange-500" />
              </div>
