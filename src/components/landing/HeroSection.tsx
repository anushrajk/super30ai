      ...
      <div className="container relative mx-auto px-4 py-8 md:py-12 lg:py-16">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-12 gap-6 md:gap-8 lg:gap-16 items-center">
          ...
          <div className="md:col-span-1 lg:col-span-7 space-y-4 md:space-y-6">
            ...
            {/* H1 and Description */}
            <div>
            <h1 className="font-bold text-foreground tracking-tight mb-4 md:mb-5">
                <span className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-brand leading-normal">
                  AI-Powered Digital
                </span>
                <span className="block text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl leading-normal">
                  Marketing Services
                </span>
              </h1>
