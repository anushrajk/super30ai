...
const clientProfiles = [
  {
    ...
    description: "Complete website and social media creative design for a leading animation studio. Cinematic visuals and modern branding crafted to match their production quality and creative identity.",
  ...
  },
  {
    ...
    description: "Bold social media creatives and performance focused website design for India's leading motorcycle racing academy. High energy visuals created to reflect speed, action, and competitive spirit.",
  ...
  {
    brand: "iSit",
    description: "Modern corporate website and branded social media creatives for an IT solutions company. Clean, professional visuals designed to enhance credibility, clarity, and digital presence.",
  ...
  },
  {
    ...
    description: "Premium e-commerce creatives and visual branding for one of India's growing artificial flower brands. Elegant designs created to highlight products and improve customer engagement.",
  ...
  },
  {
    ...
    description: "Strategic digital branding and social media campaign creatives for a top digital marketing institute. Conversion focused visuals designed to improve reach, trust, and admission inquiries.",
